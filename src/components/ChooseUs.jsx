  ...
  return (
    <div className='w-11/12 max-w-[1160x] pb-10 pt-10 mt-10'>
      ...
      <div className='flex items-center justify-center gap-20 z-150 w-full mt-10 text-center '>
        ...
        <div className='transition-[bg-gradient-to-r] duration-300 ease-in-out w-[300px] h-[250px] flex gap-4 flex-col items-center justify-center text-white hover:bg-gradient-to-r from-gray-700 via-gray-600 to-gray-500 p-4 rounded-md '>
        ...
        <div className=' w-[300px] h-[250px] flex gap-4 flex-col items-center justify-center text-white transition-all hover:bg-gradient-to-r from-gray-700 via-gray-600 to-gray-500 p-4 hover:rounded-md '>
