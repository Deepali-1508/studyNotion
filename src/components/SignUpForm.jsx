  ...
  return (
    ...
    <div className="flex bg-richblack-800 p-1 gap-x-1 rounded-full max-w-max">
      ...
      <div className='flex flex-col gap-1 '>
        ...
        <input className=' bg-richblack-800 rounded-[0.75rem] w-full p-[12px] text-richblack-5' type="text" name="fname" value={formData.fname} onChange={handleChange} required placeholder='Enter your first name' id='fname' />
      </div>
      ...
      <div className='flex flex-col gap-1 '>
        ...
        <input className=' bg-richblack-800 rounded-[0.75rem] w-full p-[12px] text-richblack-5' type="text" name="lname" value={formData.lname} onChange={handleChange} required placeholder='Enter your last name' id='lname' />
      </div>
      ...
      <div className='flex flex-col gap-1 '>
        ...
        <input className=' bg-richblack-800 rounded-[0.75rem] w-full p-[12px] text-richblack-5' type="text" name="email" value={formData.email} onChange={handleChange} required placeholder='Enter your email addresss' id='email' />
      </div>
      ...
      <div className='flex gap-[10px] '>
        ...
        <input className=' bg-richblack-800 rounded-[0.75rem] w-full p-[12px] text-richblack-5' type="password" name="password" value={formData.password} onChange={handleChange} required placeholder='Enter password' id='password' />
      </div>
      ...
      <div>
        ...
        <input className=' bg-richblack-800 rounded-[0.75rem] w-full p-[12px] text-richblack-5' type="confirmPassword" value={formData.confirmPassword} onChange={handleChange} required name="confirmPassword" placeholder='Confirm Password' id='confirmPassword' />
      </div>
      </div>
